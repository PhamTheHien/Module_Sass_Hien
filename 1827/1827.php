...
$scss = new Compiler();
$str = file_get_contents('sass/1827-styles.scss');
$str = $scss->compile($str);
file_put_contents('css/1827-styles.css', $str);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <link href="<?php echo $url_path ?>/css/1827-styles.css" rel="stylesheet" type="text/css" />
